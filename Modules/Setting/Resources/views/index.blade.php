    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="card-body">
                        <form action="{{ route('settings.update') }}" method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="company_phone">No Telpon Perusahaan <span class="text-danger">*</span></label>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="default_currency_position">Posisi Logo Mata Uang <span class="text-danger">*</span></label>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="footer_text">Catatan Footer <span class="text-danger">*</span></label>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0">Pengaturan Surat</h5>
                    </div>
                    <div class="card-body">
