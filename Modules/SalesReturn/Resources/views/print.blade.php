        ...
        <div class="col-xs-12">
            <div style="text-align: center;margin-bottom: 25px;">
                ...
                <h4 style="margin-bottom: 20px;">
                    <span>Referensi::</span> <strong>{{ $sale_return->reference }}</strong>
                </h4>
            </div>
            <div class="card">
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-xs-4 mb-3 mb-md-0">
                            <h4 class="mb-2" style="border-bottom: 1px solid #dddddd;padding-bottom: 10px;">Info Perusahaan:</h4>
                        ...
                        <div class="col-xs-4 mb-3 mb-md-0">
                            <h4 class="mb-2" style="border-bottom: 1px solid #dddddd;padding-bottom: 10px;">Info Pelanggan:</h4>
                    ...
                    <div class="table-responsive-sm" style="margin-top: 30px;">
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <th class="align-middle">Harga Satuan Unit</th>
