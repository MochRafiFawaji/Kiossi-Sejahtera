            ...
            <div class="card">
                <div class="card-body">
                    <div class="row mb-4">
                        ...
                        <div class="col-xs-4 mb-3 mb-md-0">
                            <h4 class="mb-2" style="border-bottom: 1px solid #dddddd;padding-bottom: 10px;">Info Pemasok:</h4>
                        ...
                        <div class="col-xs-4 mb-3 mb-md-0">
                            <h4 class="mb-2" style="border-bottom: 1px solid #dddddd;padding-bottom: 10px;">Info Invoice :</h4>
