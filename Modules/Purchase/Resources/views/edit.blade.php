                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status" required>
                                            <option {{ $purchase->status == 'Pending' ? 'selected' : '' }} value="Pending">Tertunda</option>
                                            <option {{ $purchase->status == 'Ordered' ? 'selected' : '' }} value="Ordered">Dipesan</option>
                                            <option {{ $purchase->status == 'Completed' ? 'selected' : '' }} value="Completed">Lengkap</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
