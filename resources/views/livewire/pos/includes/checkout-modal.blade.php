                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            ...
                            <div class="form-row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="total_amount">Jumlah Total <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group">
                                <label for="payment_method">Cara Pembayaran <span class="text-danger">*</span></label>
                                <select class="form-control" name="payment_method" id="payment_method" required>
                                    <option value="Cash">Cash</option>
                                    <option value="Credit Card">Kartu Kredit</option>
                                    <option value="Bank Transfer">Bank Transfer</option>
                                    <option value="Cheque">Kasbon</option>
                                </select>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        <th>OPajak Pesanan ({{ $global_tax }}%)</th>
