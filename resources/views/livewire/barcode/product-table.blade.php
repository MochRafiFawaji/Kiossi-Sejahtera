        ...
        <div class="card-body">
                ...
                <table class="table table-bordered mb-0">
                    ...
                    <tr class="align-middle">
                        ...
                        <th class="align-middle">
                            Kuantiti <i class="bi bi-question-circle-fill text-info" data-toggle="tooltip" data-placement="top" title="Max Quantity: 100"></i>
                        </th>
                    </tr>
                    </thead>
                    <tbody>
            ...
            <div class="mt-3">
                <button wire:click="generateBarcodes({{ $product }}, {{ $quantity }})" type="button" class="btn btn-primary">
                    <i class="bi bi-upc-scan"></i> Hasilkan Barcode
                </button>
            </div>
        </div>
    </div>
